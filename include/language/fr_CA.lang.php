...
//       it is the key for the default record_type_module value
    ...
    'dom_email_link_type' => array('sugar' => 'SuiteCRM Client Courriel',
...
$app_strings = array(
    ...
    'LBL_NO_ACTION' => 'Aucune action portant ce nom',
    'LBL_NO_DATA' => 'Aucune donnée',
    'LBL_ROUTING_ADD_RULE' => 'Ajouter une règle',
    'LBL_ROUTING_ALL' => 'Au moins',
    'LBL_ROUTING_ANY' => 'Quelconque',
    'LBL_ROUTING_BREAK' => '-',
    'LBL_ROUTING_BUTTON_CANCEL' => 'Annuler',
    'LBL_ROUTING_BUTTON_SAVE' => 'Sauvegarder les règles',

    'LBL_ROUTING_ACTIONS_COPY_MAIL' => 'Copier Courriel',
    'LBL_ROUTING_ACTIONS_DELETE_BEAN' => 'Supprimer Objet SuiteCRM',
    'LBL_ROUTING_ACTIONS_DELETE_FILE' => 'Supprimer le fichier',
    'LBL_ROUTING_ACTIONS_DELETE_MAIL' => 'Supprimer Courriel',
    'LBL_ROUTING_ACTIONS_FORWARD' => 'Transférer Courriel',
    'LBL_ROUTING_ACTIONS_MARK_FLAGGED' => 'Signaler Courriel',
    'LBL_ROUTING_ACTIONS_MARK_READ' => 'Marquer comme lu',
    'LBL_ROUTING_ACTIONS_MARK_UNREAD' => 'Marquer comme non-lu',
    'LBL_ROUTING_ACTIONS_MOVE_MAIL' => 'Déplacer Courriel',
    'LBL_ROUTING_ACTIONS_PEFORM' => 'Appliquer les actions suivantes',
    'LBL_ROUTING_ACTIONS_REPLY' => 'Répondre au Courriel',
    ...
    'LBL_ROUTING_SUB_DESC' => 'Les règles sont activées. Cliquer sur un nom pour modifier.',
    'LBL_ROUTING_TO' => 'à',
    ...
    'LBL_EMAIL_ACCOUNTS_EDIT' => 'Modifier',
    ...
    'LBL_EMAIL_ACCOUNTS_SMTPAUTH_REQ' => 'Utiliser authentification SMTP ?',
    ...
    'LBL_EMAIL_WARNING_MISSING_USER_CREDS' => 'Avertissement: Vous avez oublié de définir le nom d\'utilisateur et le mot de passe du courriel sortant',
    'LBL_EMAIL_ACCOUNTS_SMTPUSER_REQD' => 'Utilisateur SMTP requis',
    'LBL_EMAIL_ACCOUNTS_SMTPPASS_REQD' => 'Mot de passe SMTP requis',
    'LBL_EMAIL_ACCOUNTS_TITLE' => 'Gestion des Comptes Courriels',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_EMAIL_ADDR' => 'Adresse Courriel',
    'LBL_EMAIL_ADDRESS_BOOK_ERR_NOT_CONTACT' => 'Seule la modification des fiches contacts est prise en charge pour le moment.',
    ...
    'LBL_EMAIL_ADDRESSES' => 'Adresse Courriel',
    'LBL_EMAIL_ADDRESS_PRIMARY' => 'Adresse Courriel',
    'LBL_EMAIL_ADDRESSES_TITLE' => 'Adresse Courriel',
    'LBL_EMAIL_ARCHIVE_TO_SUGAR' => 'Importer à SuiteCRM',
    ...
    'LBL_EMAIL_ATTACHMENTS2' => 'A partir de Documents SuiteCRM',
    'LBL_EMAIL_ATTACHMENTS3' => 'Pièces jointes Modèle',
    'LBL_EMAIL_ATTACHMENTS_FILE' => 'Fichier',
    'LBL_EMAIL_ATTACHMENTS_DOCUMENT' => 'Document',
    'LBL_EMAIL_ATTACHMENTS_EMBEDED' => 'Encastré',
    'LBL_EMAIL_BCC' => 'CCI',
    'LBL_EMAIL_CANCEL' => 'Annuler',
    'LBL_EMAIL_CC' => 'CC',
    'LBL_EMAIL_CHARSET' => 'Encodage',
    'LBL_EMAIL_CHECK' => 'Relever Emails',
    'LBL_EMAIL_CHECKING_NEW' => 'Relever Nouveaux Emails',
    ...
    'LBL_EMAIL_COMPOSE' => 'Composer un Courriel',
    'LBL_EMAIL_COMPOSE_ERR_NO_RECIPIENTS' => 'Votre Courriel est sans Destinataire(s).',
    'LBL_EMAIL_COMPOSE_LINK_TO' => 'Associé avec',
    'LBL_EMAIL_COMPOSE_NO_BODY' => 'Le contenu du courriel est vide. Envoyer tout de même ?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT' => 'Le sujet de votre courriel est vide. Envoyer/Sauvegarder tout de même ?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT_LITERAL' => '(Aucun sujet)',
    'LBL_EMAIL_COMPOSE_READ' => 'Lire et composer un courriel',
    'LBL_EMAIL_COMPOSE_SEND_FROM' => 'Envoyer depuis le compte courriel',
    'LBL_EMAIL_COMPOSE_OPTIONS' => 'Options',
    'LBL_EMAIL_COMPOSE_INVALID_ADDRESS' => 'Veuillez saisir une adresse courriel valide pour les champs À, CC et CCI',

    'LBL_EMAIL_CONFIRM_CLOSE' => 'Supprimer ce courriel?',
    ...
    'LBL_EMAIL_DD_TEXT' => 'courriel(s) sélectionnés.',
    ...
    'LBL_EMAIL_ERROR_DELETE_GROUP_FOLDER' => 'Impossible de supprimer le dossier. Soit ce dossier ou soit un dossier lié a une boite aux lettres qui lui est associée.',
    ...
    'LBL_EMAIL_ERROR_DUPE_FOLDER_NAME' => 'Noms dossier SuiteCRM doivent être uniques.',
    'LBL_EMAIL_ERROR_EMPTY' => 'Veuillez saisir des critères de recherche.',
    'LBL_EMAIL_ERROR_GENERAL_TITLE' => 'Une erreur est survenue',
    'LBL_EMAIL_ERROR_LIST_NAME' => 'Une liste d\'emails avec ce nom existe déjà',
    ...
    'LBL_EMAIL_ERROR_NO_IMAP_FOLDER_RENAME' => 'Renommer des dossiers IMAP n\'est pas encore supporté',
    ...
    'LBL_EMAIL_IMPORTING_EMAIL' => 'Importation Courriel',
    'LBL_EMAIL_IMPORT_EMAIL' => 'Importer à SuiteCRM',
    ...
    'LBL_EMAIL_MENU_HELP_ADD_FOLDER' => 'Créer un dossier (à distance ou dans SuiteCRM)',
    'LBL_EMAIL_MENU_HELP_ARCHIVE' => 'Archiver ces Courriel(s) dans SuiteCRM',
    ...
    'LBL_EMAIL_MENU_HELP_DELETE_FOLDER' => 'Supprimer un dossier (à distance ou dans SuiteCRM)',
    'LBL_EMAIL_MENU_HELP_EDIT_CONTACT' => 'Modifier un Contact',
    'LBL_EMAIL_MENU_HELP_EDIT_LIST' => 'Modifier une liste de diffusion',
    'LBL_EMAIL_MENU_HELP_EMPTY_TRASH' => 'Vider toutes les corbeilles de ce compte',
    'LBL_EMAIL_MENU_HELP_MARK_FLAGGED' => 'Marquer ces email(s) avec un Drapeau',
    ...
    'LBL_EMAIL_MENU_HELP_RENAME_FOLDER' => 'Renommer un dossier (à distance ou dans SuiteCRM)',
    ...
    'LBL_EMAIL_ML_ADDRESSES_1' => 'Liste des adresses sélectionnées',
    ...
    'LBL_EMAIL_OPT_OUT_AND_INVALID' => 'Opted Out et Invalide',
    ...
    'LBL_EMAIL_SETTINGS_EDIT_ACCOUNT' => 'Modifier Compte Courriel',
    ...
    'LBL_EMAIL_SETTINGS_GROUP_FOLDERS_EDIT' => 'Modifier le "dossier de groupe"',
    ...
    'LBL_EMAIL_SETTINGS_SHOW_NUM_IN_LIST' => 'Courriels par Page',
    ...
    'LBL_EMAIL_TEMPLATE_EDIT_PLAIN_TEXT' => 'Le modèle de courriel est vide',
    ...
    'LBL_EMAIL_IMPORT_FAIL' => 'Echec import, le message est peut être déjà importé, ou bien il a été supprimé du serveur',
    ...
    'ERR_POTENTIAL_SEGFAULT' => 'Un défaut potentiel de segmentation Apache a été détectée. S\'il vous plaît aviser votre administrateur système pour confirmer ce problème.',
    ...
    'ERR_NO_DB' => 'Impossible de se connecter à la base de données. S\'il vous plaît se référer au journal d\'erreurs SuiteCRM pour plus de détails.',
    'ERR_DB_FAIL' => 'Échec de base de données. S\'il vous plaît se référer au journal d\'erreurs SuiteCRM pour plus de détails.',
    ...
    'ERR_DB_VERSION' => 'SuiteCRM {0} fichiers ne peut être utilisé avec un SuiteCRM {1} base de données.',
    ...
    'LBL_OPEN_ITEMS' => 'Éléments Ouverts:',
    'LBL_COMPOSE_EMAIL_BUTTON_KEY' => 'L',
    'LBL_COMPOSE_EMAIL_BUTTON_LABEL' => 'Écrire Un Courriel',
    'LBL_COMPOSE_EMAIL_BUTTON_TITLE' => 'Écrire Un Courriel',
    ...
    'LBL_EDIT_AS_NEW_BUTTON_LABEL' => 'Modifier comme Nouveau',
    'LBL_EDIT_AS_NEW_BUTTON_TITLE' => 'Modifier comme Nouveau',
    ...
    'LBL_QUOTE_TO_OPPORTUNITY_TITLE' => 'Créer une Opportunité à partir du devis',
    ...
    'LBL_INBOUNDEMAIL_ID' => 'Courriel Entrant ID',
    ...
    'LBL_TABGROUP_HOME' => 'Tableau de Bord',
    'LBL_TABGROUP_MARKETING' => 'Marketing',
    'LBL_TABGROUP_MY_PORTALS' => 'Mes Sites',
    ...
    'LOGIN_LOGO_ERROR' => 'S\'il vous plaît remplacer les logos SuiteCRM.',
    ...
    'LBL_MANAGE_SUBSCRIPTIONS' => 'Gestion des Inscriptions',
    'LBL_MANAGE_SUBSCRIPTIONS_FOR' => 'Gestion des Inscriptions de',
    'LBL_SUBSCRIBE' => 'S\'abonner',
    'LBL_UNSUBSCRIBE' => 'Se désabonner',
    // Ajax status strings
    ...
    'LBL_DISPLAY_LOG' => 'Afficher le Log',
...
Agenda: ",
    ...
    'MSG_EMPTY_LIST_VIEW_NO_RESULTS_SUBMSG' => '<item4> Pour accéder à plus d\'informations sur le module <item1>, utilisez le menu utilisateur situé sur la barre de navigation principale.',
    ...
    'LBL_CREATE_OPPORTUNITY' => 'Opportunité',
    ...
    'LBL_NEW_PAGE_FEEDBACK' => 'Vous avez créé une nouvelle page. Vous pouvez ajouter du contenu avec l\'option de menu Ajouter Dashlets.',
    ...
    'LBL_MAX_DASHLETS_REACHED' => 'Vous avez atteint le nombre maximum de SuiteCRM Dashlets que votre administrateur a défini. S\'il vous plaît supprimer un SuiteCRM Dashlet pour ajouter plus.',
    ...
    'LBL_SEARCH_REPORT_CHARTS' => 'Charts de rapport',
    ...
    'LBL_PORTAL_WELCOME_TITLE' => 'Bienvenue sur le portail CRM',
    ...
    //martin #25548
    'LBL_NO_FLASH_PLAYER' => 'Vous n\'avez pas activé ou vous avez une ancienne version d\'Adobe Flash Player. Pour avoir la dernière version, <a href="http://www.adobe.com/go/getflashplayer/">cliquer ici</a>.',
    //Collection Field
...
"Ceci est un fichier d\'import de base qui fournit un exemple du contenu attendu d\'un fichier prêt à être importé."<br />"Ce fichier est un fichier .csv délimité par un point-virgule utilisant des guillemets comme qualificateur de champ."<br /><br />"La ligne d\'entête est la toute première ligne du fichier et elle contient le nom des champs tels que vous les verriez dans l\'application."<br />"Ces libellés sont utilisés pour le mapping de données du fichier avec les données de votre SugarCRM."<br /><br />"Remarques: Le noms des champs en base de données peuvent aussi être utilisés en ligne d\'entête. Ceci est pratique si vous utilisez phpMyAdmin ou un autre outil de gestion de base de données pour fournir des données à importer."<br />"L\'ordre des champs n\'est pas critique puisque le process d\'import fait correspondre les données à partir des champs définis dans la ligne d\'entête."<br /><br /><br />"Pour utiliser ce modèle de fichier, faites les choses suivantes:"<br />"1. Enlever les données d\'exemple"<br />"2. Enlever le texte d\'aide que vous êtes en train de lire"<br />"3. Insérer vos propres données dans les colonnes appropriées"<br />"4. Sauvegarder le fichier sur votre ordinateur local"<br />"5. Cliquez sur les options d\'import du menu d\'actions dans l\'application et choisissez le fichier à transmettre"',
    ...
    'LBL_EDIT_BUTTON_TITLE' => 'Modifier [Alt+E]',
...
$app_list_strings['moduleList']['AOP_AOP_Case_Events'] = 'Événements du Ticket';
$app_list_strings['moduleList']['AOP_AOP_Case_Updates'] = 'Mises à jour du Ticket';
...
$app_list_strings['moduleList']['AOR_Charts'] = 'Charts de rapport';
...
$app_list_strings['aor_sql_operator_list']['Contains'] = 'COMME';
$app_list_strings['aor_sql_operator_list']['Starts_With'] = 'COMME';
$app_list_strings['aor_sql_operator_list']['Ends_With'] = 'COMME';
...
$app_list_strings['aor_email_type_list']['Email Address'] = 'Courriels';
...
$app_list_strings['date_time_period_list']['last_year'] = 'l\'Année Dernière';
...
$app_list_strings['aow_email_type_list']['Email Address'] = 'Courriels';
...
$app_list_strings['moduleList']['AM_ProjectHolidays'] = 'Périodes des vacances du projet';
...
$app_strings['LBL_QUICK_ACCOUNT'] = 'Créer un Compte';
$app_strings['LBL_QUICK_CONTACT'] = 'Créer un Contact';
$app_strings['LBL_QUICK_OPPORTUNITY'] = 'Opportunité';
...
$app_list_strings['collection_temp_list'] = array('Tasks' => 'Tâches', 'Meetings' => 'Réunions', 'Calls' => 'Appels', 'Notes' => 'Notes', 'Emails' => 'Courriels');
