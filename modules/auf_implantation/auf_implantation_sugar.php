 ...
 * PLACE ANY CUSTOMIZATIONS IN auf_implantation
 */

require_once('include/SugarObjects/templates/company/Company.php');

class auf_implantation_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'auf_implantation';
	var $object_name = 'auf_implantation';
	var $table_name = 'auf_implantation';
	var $importable = true;
	var $disable_row_level_security = true ; // to ensure that modules created and deployed under CE will continue to function under team security if the instance is upgraded to PRO
		...
		function auf_implantation_sugar(){	
		parent::Company();
	}
