...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_SKYPEOUT_ON' => 'Activer Intégration de SkypeOut&reg; ?',
    ...
    'LBL_ENABLE_INLINE_EDITING_DETAIL' => 'Activer l\'édition en ligne sur vue détaillée',
    'LBL_ENABLE_INLINE_EDITING_DETAIL_DESC' => 'Sélectionnez pour permettre l\'édition en ligne pour les champs dans la vue de détail. Si l\'édition en ligne n\'est pas sélectionnée elle sera désactivée sur la vue de détail.',
    ...
    'LOCK_HOMEPAGE_HELP'=>'Cochez cette case afin d\'empêcher les utilisateurs:<br /> 1) d\'ajouter de nouveaux onglets et dashlets sur la page d\'accueil .<br />2) de modifier la disposition des Dashlets par glisser-déposer.',
    ...
    'NEW_LOGO_HELP_NO_SPACE'=>'Le format d\'image doit être .png ou .jpg. La hauteur maximale est de 17px, et la largeur maximale est de 450px. Toutes images ayant une résolution supérieure à ces valeurs sera redimensionnée. Le nom du fiche ne peut pas contenir de caractère espace.',
    ...
    'PDF_IMAGE_SCALE_RATIO' => 'Ratio d\'échelle pour les images',
...
"More help : www.tcpdf.org" ',
    ...
    'LBL_PDF_PATCH' => 'Patch',
    'LBL_PDF_PATCH_INFO' => 'Personnalisation de l\'encodage. Ecrire un tableau PHP.<br>Exemple :<br>ISO-8859-1 ne contient pas le symbole euro. Pour ajouter celui-ci à la position 164, écrire"array(164=>\\\'Euro\\\')".',
