...
<tr>
<td width='99%'>
<input type="hidden" class="sugar_field" id="{{$displayParams.key}}_address_street_num_c" value="{$fields.{{$displayParams.key}}_address_street_num_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
...
<input type="hidden" class="sugar_field" id="ville_lg_origine_c" value="{$fields.ville_lg_origine_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
<input type="hidden" class="sugar_field" id="cedex_c" value="{$fields.cedex_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}">
...
{$fields.{{$displayParams.key}}_address_street_num_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}, 
{$fields.{{$displayParams.key}}_address_street.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br>
{$fields.ville_lg_origine_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br>
{$fields.cedex_c.value|escape:'htmlentitydecode'|escape:'html'|url2html|nl2br}<br>
