...
$app_list_strings['fs_fourniseur_type_dom']['Analyst'] = 'Аналитик';
$app_list_strings['fs_fourniseur_type_dom']['Competitor'] = 'Конкурент';
$app_list_strings['fs_fourniseur_type_dom']['Customer'] = 'Клиент';
$app_list_strings['fs_fourniseur_type_dom']['Integrator'] = 'Интегратор';
$app_list_strings['fs_fourniseur_type_dom']['Investor'] = 'Инвестор';
$app_list_strings['fs_fourniseur_type_dom']['Partner'] = 'Партнер';
$app_list_strings['fs_fourniseur_type_dom']['Press'] = 'Пресса';
$app_list_strings['fs_fourniseur_type_dom']['Prospect'] = 'Адресат';
$app_list_strings['fs_fourniseur_type_dom']['Reseller'] = 'Реселлер';
$app_list_strings['fs_fourniseur_type_dom']['Other'] = 'Другое';
...
$app_list_strings['auf_implantation_type_dom']['Provider'] = 'Поставщик';
$app_list_strings['auf_implantation_type_dom']['Delivery service'] = 'Служба доставки';
$app_list_strings['auf_implantation_type_dom'][''] = '';
$app_list_strings['auf_implantation_type_dom']['Analyst'] = 'Аналитик';
$app_list_strings['auf_implantation_type_dom']['Competitor'] = 'Конкурент';
$app_list_strings['auf_implantation_type_dom']['Customer'] = 'Клиент';
$app_list_strings['auf_implantation_type_dom']['Integrator'] = 'Интегратор';
$app_list_strings['auf_implantation_type_dom']['Investor'] = 'Инвестор';
$app_list_strings['auf_implantation_type_dom']['Partner'] = 'Партнер';
$app_list_strings['auf_implantation_type_dom']['Press'] = 'Пресса';
$app_list_strings['auf_implantation_type_dom']['Prospect'] = 'Адресат';
$app_list_strings['auf_implantation_type_dom']['Reseller'] = 'Реселлер';
$app_list_strings['auf_implantation_type_dom']['Other'] = 'Другое';
