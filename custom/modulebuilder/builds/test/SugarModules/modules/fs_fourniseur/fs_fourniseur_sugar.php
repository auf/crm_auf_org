 ...
 * PLACE ANY CUSTOMIZATIONS IN fs_fourniseur
 */

require_once('include/SugarObjects/templates/company/Company.php');

class fs_fourniseur_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'fs_fourniseur';
	var $object_name = 'fs_fourniseur';
	var $table_name = 'fs_fourniseur';
	var $importable = true;
