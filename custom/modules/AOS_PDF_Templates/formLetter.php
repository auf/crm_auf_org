...
class formLetter{
	...
	static function LVPopupHtml($module){
		...
		echo '<tr style="height:10px;"><tr><tr><td colspan="2"><button style=" display: block;margin-left: auto;margin-right: auto" onclick="document.getElementById(\'popupDivBack_ara\').style.display=\'none\';document.getElementById(\'popupDiv_ara\').style.display=\'none\';return false;">Annuler</button></td></tr>
			</table>
				</div>
	...
	static function DVPopupHtml($module){
		...
		echo '		<input type="hidden" name="templateID" value="" />
				...
				<tr style="height:10px;"><tr><tr><td colspan="2"><button style=" display: block;margin-left: auto;margin-right: auto" onclick="document.getElementById(\'popupDivBack_ara\').style.display=\'none\';document.getElementById(\'popupDiv_ara\').style.display=\'none\';return false;">Annuler</button></td></tr>
				</table>
				</div>
