...
EOQ;
		...
		$button .= "<input type='hidden' name='primary_address_street_num_c' id='primary_address_street' value='". $_REQUEST["primary_address_street_num_c"] ."'>";
		$button .= "<textarea name='primary_address_street' id='primary_address_street'>" . str_replace("&lt;br&gt;", "\n", $_REQUEST["primary_address_street"]) . "</textarea></span>";
		$button .= "<input type='hidden' name='primary_address_city' id='primary_address_city' value='". $_REQUEST["primary_address_city"] ."'>";
		$button .= "<input type='hidden' name='ville_lg_origine_c' id='ville_lg_origine_c' value='". $_REQUEST["ville_lg_origine_c"] ."'>";
		$button .= "<input type='hidden' name='cedex_c' id='cedex_c' value='". $_REQUEST["cedex_c"] ."'>";
		...
		$button .= "<input type='hidden' name='pays_text_c' id='pays_text_c' value='". $_REQUEST["pays_text_c"] ."'>";
		...
		$button .= "<span style='display: none'>";
		$button .= "<input type='hidden' name='alt_address_street_num_c' id='alt_address_city' value='". $_REQUEST["primary_address_street_num_c"] ."'>";
		$button .= "<textarea name='alt_address_street' id='alt_address_street'>" . str_replace("&lt;br&gt;", "\n", $_REQUEST["primary_address_street"]) . "</textarea></span>";
