<?php 
 $GLOBALS["dictionary"]["Opportunity"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Montant financé',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'montant_finance_c',
      'vname' => 'LBL_MONTANT_FINANCE',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'precision' => 6,
      'id' => 'Opportunitiesmontant_finance_c',
      'custom_module' => 'Opportunities',
    ),
    'etapes_d_implantation_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Etapes d implantation',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'etapes_d_implantation_c',
      'vname' => 'LBL_ETAPES_D_IMPLANTATION',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'etapes_d_implantation_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Opportunitiesetapes_d_implantation_c',
      'custom_module' => 'Opportunities',
    ),
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Pourquoi perdu',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'pourquoi_perdu_c',
      'vname' => 'LBL_POURQUOI_PERDU',
      'type' => 'text',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'rows' => '4',
      'cols' => '20',
      'id' => 'Opportunitiespourquoi_perdu_c',
      'custom_module' => 'Opportunities',
    ),
    'montant_initial_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Montant initial',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'montant_initial_c',
      'vname' => 'LBL_MONTANT_INITIAL',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Opportunitiesmontant_initial_c',
      'custom_module' => 'Opportunities',
    ),
    ...
    'fs_fourniseur_opportunities_1_name' => 
    array (
    ...
    'fs_fourniseur_opportunities_1fs_fourniseur_ida' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Scientifique',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'scientifique_c',
      'vname' => 'LBL_SCIENTIFIQUE ',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'scientifique_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Opportunitiesscientifique_c',
      'custom_module' => 'Opportunities',
    ),
    'montant_propositions_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Montant propositions',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'montant_propositions_c',
      'vname' => 'LBL_MONTANT_PROPOSITIONS',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Opportunitiesmontant_propositions_c',
      'custom_module' => 'Opportunities',
    ),
    'montant_partenariats_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Montant partenariats',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'montant_partenariats_c',
      'vname' => 'LBL_MONTANT_PARTENARIATS',
      'type' => 'currency',
      'massupdate' => '0',
      'default' => '0',
      'no_default' => false,
      ...
      'enable_range_search' => false,
      'precision' => 6,
      'id' => 'Opportunitiesmontant_partenariats_c',
      'custom_module' => 'Opportunities',
    ),
    'jjwg_maps_lat_c' => 
    array (
    ...
    array (
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'familles_list',
      'studio' => 'visible',
      'dependency' => NULL,
      'id' => 'Opportunitiesfamilles_c',
      'custom_module' => 'Opportunities',
    ),
  ),
  'indices' => 
