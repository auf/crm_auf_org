...
<input type='text' name='{$fields.address_postalcode_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='pays_iso2_c_advanced'>{sugar_translate label='LBL_PAYS_ISO2_C' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
{html_options id='pays_iso2_c_advanced' name='pays_iso2_c_advanced[]' options=$fields.pays_iso2_c_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.pays_iso2_c_advanced.value}
   	   	</td>
