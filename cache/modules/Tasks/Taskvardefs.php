<?php 
 $GLOBALS["dictionary"]["Task"]=array (
  ...
  array (
    ...
    'fs_fourniseur_tasks_1fs_fourniseur_ida' => 
    array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Création fiche fournisseur CODA',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'cre_fic_four_coda_c',
      'vname' => 'LBL_CRE_FIC_FOUR_CODA',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    'aos_quotes_tasks_1aos_quotes_ida' => 
    array (
