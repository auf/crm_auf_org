...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='pays_iso2_c_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PAYS_ISO2_C','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('id' => 'pays_iso2_c_advanced','name' => 'pays_iso2_c_advanced[]','options' => $this->_tpl_vars['fields']['pays_iso2_c_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['pays_iso2_c_advanced']['value']), $this);?>
